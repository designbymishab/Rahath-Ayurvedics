...
export default function WhatsAppButton() {
    const handleClick = () => {
        ...
        if (typeof window !== 'undefined' && (window as any).va) {
            ((window as any).va as (event: string, data: Record<string, string>) => void)('event', { name: 'whatsapp_button_click' });
        }
    };

    return (
        <a
            href="https://wa.me/919605424292?text=Hello%2C%20I%20want%20to%20enquire%20about%20your%20herbal%20medicines"
            target="_blank"
