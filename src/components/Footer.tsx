                ...
                <div className="footer-grid" style={{
                    ...
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                            <Image src="/Logo/android-chrome-512x512.png" alt="Rahath Ayurvedic Logo" width={50} height={50} style={{ borderRadius: '4px' }} />
                            <h3 style={{ color: 'var(--white)', fontSize: '1.5rem' }}>{language === 'ml' ? 'റാഹത്ത് ആയുർവേദിക്' : 'Rahath Ayurvedic'}</h3>
                        </div>
                        <p style={{ opacity: 0.8, marginBottom: '24px', maxWidth: '300px' }}>{t.footer.desc}</p>
                    ...
                    <div>
                        ...
                        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            <li><Link href="/" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.nav.home}</Link></li>
                            <li><Link href="/about" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.nav.about}</Link></li>
                            <li><Link href="/blog" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.nav.blog}</Link></li>
                    ...
                    {/* Services */}
                    <div>
                        <h4 style={{ color: 'var(--white)', marginBottom: '24px' }}>{t.footer.services}</h4>
                        <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            <li><Link href="/specialities/raw-herbal-medicines" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.specialities.items[0].title}</Link></li>
                            <li><Link href="/specialities/piles-care" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.specialities.items[1].title}</Link></li>
                            <li><Link href="/specialities/postnatal-care" style={{ opacity: 0.8, textDecoration: 'none', color: 'inherit' }}>{t.specialities.items[2].title}</Link></li>
                        </ul>
                    </div>
